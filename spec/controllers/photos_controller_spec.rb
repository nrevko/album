...
describe PhotosController do
  ...
  def valid_attributes
    {:album_id => @album.id, :name => 'Pretty'}
  end

  describe "GET index" do
    it "assigns all photos as @photos" do
      photo = Photo.create! valid_attributes
      get :index, :album_id => photo.album_id
  ...
  describe "GET show" do
    it "assigns the requested photo as @photo" do
      photo = Photo.create! valid_attributes
      get :show, :id => photo.id, :album_id => photo.album_id
  ...
  describe "GET edit" do
    it "assigns the requested photo as @photo" do
      photo = Photo.create! valid_attributes
      get :edit, :id => photo.id, :album_id => photo.album_id
      assigns(:photo).should eq(photo)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Photo" do
        expect {
          post :create, :photo => valid_attributes, :album_id => valid_attributes[:album_id]
        }.to change(Photo, :count).by(1)
      end

      it "assigns a newly created photo as @photo" do
        post :create, :photo => valid_attributes,:album_id => @album.id
      ...
      it "redirects to the created photo" do
        post :create, :photo => valid_attributes, :album_id => @album.id
        response.should redirect_to(album_photo_url(Photo.last, :album_id=>Photo.last.album_id))
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved photo as @photo" do
        ...
        post :create, :photo => {}, :album_id => @album.id
        assigns(:photo).should be_a_new(Photo)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested photo" do
        ...
        put :update, :id => photo.id, :photo => {'these' => 'params'}, :album_id => photo.album_id
      end

      it "assigns the requested photo as @photo" do
        photo = Photo.create! valid_attributes
        put :update, :id => photo.id, :photo => valid_attributes, :album_id => photo.album_id
        assigns(:photo).should eq(photo)
      end
      ...
      it "redirects to the photo" do
        photo = Photo.create! valid_attributes
        put :update, :id => photo.id, :photo => valid_attributes, :album_id => photo.album_id
        response.should redirect_to(album_photo_path)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the photo as @photo" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Photo.any_instance.stub(:save).and_return(false)
        put :update, :id => photo.id, :photo => {}, :album_id => photo.album_id
        assigns(:photo).should eq(photo)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested photo" do
      photo = Photo.create! valid_attributes
      expect {
        delete :destroy, :id => photo.id, :album_id => photo.album_id
      }.to change(Photo, :count).by(-1)
    end
